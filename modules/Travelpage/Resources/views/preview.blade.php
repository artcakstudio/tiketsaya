                                                    ...
                                                    <tr>
                                                        <td class="box_logo_penerbangan_asal">
                                                            <div class="logo_penerbangan_asal">
                                                                <img onError="this.onerror=null;this.src='<?php echo url('assets/image/noimage.png')?>'" src="<?php echo url('public\Assets\partnerPhoto/'.Session::get('DATA_TRAVEL')['PARTNER_PHOTO'].'')?>" width=90 height=52>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
