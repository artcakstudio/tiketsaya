                    ...
                    <div class="row" style="margin-top:90px">
                        ...
                        <div class="col-md-4 remove_padding"  style="background-color:#fff;border: 1px solid #ddd; border-left: 5px solid #00cd00">
                            <div class="info_logo_merk_travel">
                                <img onError="this.onerror=null;this.src='<?php echo url('assets/images/noimage.png')?>'" src="<?php echo url('public/Assets/partnerPhoto/'.Session::get('DATA_TRAVEL')['PARTNER_PHOTO'].'')?>" width=92 height=50></img>
                            </div>
                            <div clas="info_logo_kendaraan_travel" style="margin-left:170px; margin-top:-50px">
                                <img onError="this.onerror=null;this.src='<?php echo url('assets/images/noimage.png')?>'" src="<?php echo url('public/Assets/vehiclePhoto/'.Session::get('DATA_TRAVEL')['VEHICLE_PHOTO'].'')?>" width=92 height=56></img>
                            </div>
                        ...
                        {!!Form::open(['route'=>'travelpage.transaksi.preview','method'=>'post'])!!}
                        <div class="col-md-8"style=" padding-left:30px; margin-top:-10px;z-index:1000">
                            <div class="judul">
                                <h4>Isi data pemesan yang dapat dihubungi<h4>
                            </div>
                            <input type="hidden" name="TRAVEL_SCHEDULE_ID" value="{{$id_schedule}}">
                            <input type="hidden" id="totalHargaHidden" name="TRAVEL_TRANSACTION_PRICE" value="{{Session::get('DATA_TRAVEL')['TRAVEL_SCHEDULE_PRICE']}}">
                            ...
                            <div class="form_data_penumpang" style="margin-top:-20px">
                             ...
                             <div class="form_data_penumpang" style="margin-top:-20px">
                                ...
                                <div class="kotak_email">
                                    <select style="height:30px ;" onchange="updateHarga()" name="TRAVEL_TRANSACTION_PASSENGER">
                                        @for($i=1; $i <= $sisa; $i++)
                        ...
                        <div class="col-md-4 remove_padding"  style="background-color:#eee; margin-top:20%; position:absolute">
                            ...
                            <div class="daftar_harga col-md-5" style="width:45%;position:absolute;margin-left:55%; padding-right:10px ">
                                <div class="harga_1">
                                    <span style="float:left">Rp</span><p><b id="harga">{{Session::get('DATA_TRAVEL')['TRAVEL_SCHEDULE_PRICE']}}</b></p>
                                </div>
                                <div class="harga_2">
                                ...
                                <div class="harga_4" style="font-size:16px">
                                    <span style="float:left"><b>Rp</b></span><p><b id="totalharga">{{Session::get('DATA_TRAVEL')['TRAVEL_SCHEDULE_PRICE']}}</b></p>
                                </div>
                            </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-8" style="margin-left:325px; margin-top:-150px; margin-bottom:20px">
                            ...
                            <div class="notes_data_tambahan_penumpang" style="background-color:#ffff9a; font-size: 16px; margin-top:27%">
                                ...
                                <ul><h4><b>Tambahan: </b></h4>
                                  <li>Pihak Travel tetap dapat meng-update harga. Harga final akan Anda dapatkan di halaman review pembayaran</li>
...
<script type="text/javascript">
    function updateHarga () {
        var harga=$("select[name='TRAVEL_TRANSACTION_PASSENGER']").val();
