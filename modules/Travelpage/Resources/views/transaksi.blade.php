                    ...
                    <div class="row" style="margin-top:90px">
                        ...
                        <div class="col-md-4 remove_padding"  style="background-color:#fff;border: 1px solid #ddd; border-left: 5px solid #00cd00">
                            <div class="info_logo_merk_travel">
                                <img onError="this.onerror=null;this.src='<?php echo url('assets/image/noimage.png')?>'" src="<?php echo url('public/Assets/partnerPhoto/'.Session::get('DATA_TRAVEL')['PARTNER_PHOTO'].'')?>" width=92 height=50></img>
                            </div>
                            <div clas="info_logo_kendaraan_travel" style="margin-left:170px; margin-top:-50px">
                                <img onError="this.onerror=null;this.src='<?php echo url('assets/image/noimage.png')?>'" src="<?php echo url('public/Assets/vehiclePhoto/'.Session::get('DATA_TRAVEL')['VEHICLE_PHOTO'].'')?>" width=92 height=56></img>
                            </div>
